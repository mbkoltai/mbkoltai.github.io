...
This is a simple calculator that shows how many years are needed to get to a given savings goal, as a function of the yearly savings rate and the rate of return. 
The calculation is in nominal terms, so not adjusting for inflation.
...
<a href="https://mbkoltai.shinyapps.io/years_to_save_reinvest_to_reach_amount/" class="button">Time to savings goal calculator (Shinyapp)</a>
