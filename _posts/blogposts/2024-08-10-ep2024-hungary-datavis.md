...
There are 106 parliamentary constituencies (OEVK) in Hungary. I mapped the above results from individual settlements onto these 106 electoral districts, shown on Figure 10.  I took the non-far-right opposition parties as one bloc and calculated the percentage _difference_ between the FIDESZ and opposition voting blocs, with the colour coding showing districts going for FIDESZ (orange) or the opposition (blue).
