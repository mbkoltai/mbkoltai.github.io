...
One of the first things I wanted to do for this blog is to be able to write equations as in LaTeX. I thought this would be straightforward, but it took some searching to find out a better solution than embedding images of the equations generated by an external tool.
