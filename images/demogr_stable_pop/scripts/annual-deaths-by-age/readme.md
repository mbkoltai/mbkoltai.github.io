...
This data package contains the data that powers the chart ["Number of deaths by age"](https://ourworldindata.org/grapher/annual-deaths-by-age?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
