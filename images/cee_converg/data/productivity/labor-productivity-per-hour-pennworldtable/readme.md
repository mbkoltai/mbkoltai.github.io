...
This data package contains the data that powers the chart ["Productivity: output per hour worked"](https://ourworldindata.org/grapher/labor-productivity-per-hour-pennworldtable?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on December 02, 2025.
...
#### Full citation
Feenstra et al. - Penn World Table (2025) – with major processing by Our World in Data. “Productivity: output per hour worked – Penn World Table – In constant international-$” [dataset]. Feenstra et al., “Penn World Table 11.0” [original data].
...
* This data is expressed in [international-$](#dod:int_dollar_abbreviation) at 2021 prices, using a multiple benchmark approach that incorporates PPP estimates from all available benchmark years.
