...
ui <- fluidPage(
  ...
  tags$head(
    tags$style(HTML("
      body, .shiny-text-output, .shiny-input-container {
  ...
  tags$h1(
    style = "font-family: Calibri; font-size: 30px;",  # optional: adjust font size
  ...
  HTML("Válassz egy adatforrást a fenti menüből, és az ábra automatikusan frissül. <br> <br>
      ...
      ami a KSH 2025-ös becslése szerint kb. 7.88 millió ember. <br> 
      ...
      A 74 éven felüliek végzettség szerinti eloszlásánál feltételezésekkel kellett élnem, 
      mivel nem találtam erre vonatkozó adatot a KSH-nál. 
      ...
      A MEDIÁN 2002-es választások óta adott választás előtti - az eredményekkel összehasonlított - előrejelzéseit 
      ...
      A többi közvéleménykutató <i> record</i>-ja annyira zűrös, hogy inkább nem használtam őket, 
      illetve demográfiai lebontást általában nem is csinálnak."
      ), 
